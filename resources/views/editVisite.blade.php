                    ...
                    <div class="flex-row  text-dark  justify-content-center mb-3">
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class="d-flex flex-column text-start">
                                ...
                                <textarea class="form-control" rows="5" name="Description">{{$visite->Description}}</textarea>
                            </div>
                            <div class="d-flex flex-column text-start	">
                                <span>Conclusion</span>
                                <textarea class="form-control" rows="5" name="Conclusion">{{$visite->Conclusion}}</textarea>
                            </div>
                        </div>
                    </div>
